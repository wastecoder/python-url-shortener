...
def test_a_refused_target_url_answers_400_carrying_its_reason(client: TestClient) -> None:
    """
...
def test_an_unknown_code_answers_404_without_the_extension_members(client: TestClient) -> None:
    """
...
def test_a_malformed_body_answers_422_naming_the_field_it_refused(client: TestClient) -> None:
    """
...
def test_the_validation_body_never_echoes_the_payload_back(client: TestClient) -> None:
    """
    ...
    """
    response = client.post("/validated", json={"url": {"secret": "do-not-echo-me"}})
...
def test_a_wrong_method_answers_in_the_same_envelope_and_keeps_allow(client: TestClient) -> None:
    """
...
def test_a_path_no_route_matches_answers_in_the_same_envelope(client: TestClient) -> None:
    """
...
def test_an_unexpected_failure_answers_500_without_leaking_the_cause(client: TestClient) -> None:
    """
